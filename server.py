...
SUBJECT_MAP = {
    ...
    "I": {"name": "应收账款", "codes": ["1122"]},
    "J": {"name": "应付账款", "codes": ["2202"]},
    "K": {"name": "应付票据", "codes": ["2201"]},
    "L": {"name": "应付职工薪酬", "codes": ["2211"]},
    "M": {"name": "应交税费", "codes": ["2221"]},
    "N": {"name": "其他应付款", "codes": ["2241"]},
    "O": {"name": "存货", "codes": ["1403","1405"]},
    "P": {"name": "固定资产", "codes": ["1601"]},
    "Q": {"name": "无形资产", "codes": ["1701"]},
    "R": {"name": "长期借款", "codes": ["2501"]},
}
...
async def demo_result(subject: str = "C"):
    demos = {
        ...
        "I": {"subject":"I","subject_name":"应收账款","entity_name":"重庆蛮先进智能制造有限公司","period":"2024-12-31",
              "summary":"应收账款期末余额1,850,000元。湖北双环科技1,300,000元占比70%，需重点函证。账龄1年以内84.86%，结构优良。周转率5.2%正常。",
              "sheets":["I-1 应收账款审定表","I-2 应收账款明细表","I-3 账龄分析表","I-4 函证汇总表","I-5 预期信用损失检查表","I-6 坏账准备计算表"],
              "audit_findings":[{"severity":"info","msg":"周转率5.2%稳定，回款质量正常"},{"severity":"warning","msg":"湖北双环科技1,300,000元（占比70%），需重点函证"},{"severity":"warning","msg":"2年以上长账龄合计70,000元（3.78%），风险可控"}]},
        "J": {"subject":"J","subject_name":"应付账款","entity_name":"重庆蛮先进智能制造有限公司","period":"2024-12-31",
              "summary":"应付账款期末余额2,600,000元。账龄1年以内占比92%，无长期拖欠。主要供应商集中度中等。",
              "sheets":["J-1 应付账款审定表","J-2 应付账款明细表","J-3 账龄分析表","J-4 函证汇总表"],
              "audit_findings":[{"severity":"info","msg":"应付账款1年以内占比92%，付款正常"},{"severity":"warning","msg":"2年以上挂账55,000元，需了解原因"}]},
        "K": {"subject":"K","subject_name":"应付票据","entity_name":"重庆蛮先进智能制造有限公司","period":"2024-12-31",
              "summary":"应付票据期末余额1,200,000元，均为银行承兑汇票。无逾期未兑付情况。保证金比例合规。",
              "sheets":["K-1 应付票据审定表","K-2 应付票据明细表","K-3 票据备查簿核对表"],
              "audit_findings":[{"severity":"info","msg":"应付票据均为银承，无逾期"},{"severity":"warning","msg":"银承保证金需与货币资金核对一致"}]},
        "L": {"subject":"L","subject_name":"应付职工薪酬","entity_name":"重庆蛮先进智能制造有限公司","period":"2024-12-31",
              "summary":"应付职工薪酬期末余额850,000元。工资计提与发放勾稽一致。社保公积金计提比例合规。",
              "sheets":["L-1 应付职工薪酬审定表","L-2 应付职工薪酬明细表","L-3 薪酬分配检查表"],
              "audit_findings":[{"severity":"info","msg":"工资计提与实发勾稽一致"},{"severity":"warning","msg":"年终奖计提需检查是否足额"}]},
        "M": {"subject":"M","subject_name":"应交税费","entity_name":"重庆蛮先进智能制造有限公司","period":"2024-12-31",
              "summary":"应交税费期末余额320,000元。增值税、企业所得税计提计算正确。无逾期未缴纳税款。",
              "sheets":["M-1 应交税费审定表","M-2 应交税费明细表","M-3 纳税申报核对表"],
              "audit_findings":[{"severity":"info","msg":"增值税、企业所得税计提正确"},{"severity":"warning","msg":"需取得完税证明进行交叉核对"}]},
        "N": {"subject":"N","subject_name":"其他应付款","entity_name":"重庆蛮先进智能制造有限公司","period":"2024-12-31",
              "summary":"其他应付款期末余额450,000元。主要为押金保证金和代扣代缴款项。无异常大额挂账。",
              "sheets":["N-1 其他应付款审定表","N-2 其他应付款明细表","N-3 账龄分析表"],
              "audit_findings":[{"severity":"info","msg":"主要为押金保证金，性质正常"},{"severity":"warning","msg":"1年以上挂账120,000元，需了解原因"}]},
        "O": {"subject":"O","subject_name":"存货","entity_name":"重庆蛮先进智能制造有限公司","period":"2024-12-31",
              "summary":"存货期末余额9,400,000元。原材料3,800,000元，库存商品5,600,000元。存货周转正常，未发现积压或减值迹象。",
              "sheets":["O-1 存货审定表","O-2 存货明细表","O-3 存货盘点表","O-4 存货跌价准备测试表"],
              "audit_findings":[{"severity":"info","msg":"存货周转率正常"},{"severity":"warning","msg":"原材料中部分库龄>1年的需关注减值"}]},
        "P": {"subject":"P","subject_name":"固定资产","entity_name":"重庆蛮先进智能制造有限公司","period":"2024-12-31",
              "summary":"固定资产期末原值12,670,000元，累计折旧3,200,000元。本期新增设备350,000元，处置180,000元。折旧计提正确。",
              "sheets":["P-1 固定资产审定表","P-2 固定资产明细表","P-3 折旧测算表","P-4 固定资产盘点表"],
              "audit_findings":[{"severity":"info","msg":"折旧计提方法与上年一致"},{"severity":"warning","msg":"需对新增设备执行实物盘点"}]},
        "Q": {"subject":"Q","subject_name":"无形资产","entity_name":"重庆蛮先进智能制造有限公司","period":"2024-12-31",
              "summary":"无形资产期末净值2,100,000元。主要为专利权和软件。摊销计提正确，无减值迹象。",
              "sheets":["Q-1 无形资产审定表","Q-2 无形资产明细表","Q-3 摊销测算表"],
              "audit_findings":[{"severity":"info","msg":"摊销年限符合会计政策"},{"severity":"warning","msg":"需检查专利权权属文件"}]},
        "R": {"subject":"R","subject_name":"长期借款","entity_name":"重庆蛮先进智能制造有限公司","period":"2024-12-31",
              "summary":"长期借款期末余额8,000,000元。建行5,000,000元（2027年到期）+工行3,000,000元（2028年到期）。利息计提正确，1年内到期部分已重分类。",
              "sheets":["R-1 长期借款审定表","R-2 借款明细及利息复核表","R-3 函证汇总表","R-4 一年内到期重分类检查表"],
              "audit_findings":[{"severity":"info","msg":"利息计提与借款合同一致"},{"severity":"warning","msg":"建行借款2027年到期，需关注还款计划"}]},
    }
